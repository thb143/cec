...
public class PersonAction {
	...
	public void set(Model model) {
		model.addAttribute(securityService.getCurrentUser().getSettings());
	}
	 ...
	 * @return 返回提示信息。
	 */
	@RequestMapping("person-set-save")
	public ModelAndView setSave(UserSettings userSettings) {
		securityService.updateUserSettings(userSettings);
		return DialogResultUtils.close(messageSource.get("person.set.success"));
	}
}
