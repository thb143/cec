	   ...
	   <@pro.benefitCardTypePolicy_head benefitCardType=benefitCardTypeLog.type/>
		<div class="pageFormContent" layoutH="111">
		   ...
		   <#if benefitCardTypeLog.type.isBounded()>
		   		<@pro.benefitCardTypeSnackRule_list benefitCardType=benefitCardTypeLog.type.boundType show=false />
		   <#else>
		   		<@pro.benefitCardTypeSnackRule_list benefitCardType=benefitCardTypeLog.type show=false />
		   </#if>
	    </div>
