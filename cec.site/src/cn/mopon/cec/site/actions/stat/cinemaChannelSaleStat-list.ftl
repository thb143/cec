...
<div class="pageHeader">
   <!--   <@dwz.pageForm action="/stat/channelCinemaSaleStat-list" alt="可输入影院编码、影院名称检索" >
    ...
    <div class="pageContent" id="cinemaChannelSaleStat">
        <table class="list" width="99%" layoutH="20">
            <thead>
            <tr>
                <th width="30" align="center" rowspan="2">序号</th>
                <th align="center" width="200" rowspan="2">渠道名称</th>
