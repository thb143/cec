<div class="page" layouth="0">
    <div class="pageFormContent">
	    <form class="pageForm required-validate" action="${ctx}/api/ticket/v1/releaseSeats">
	        <fieldset>
	            <legend>解锁锁座接口</legend>
	            <dl>
	                <dt>渠道编号:</dt>
	            ...
	            <dl>
	                <dt>订单号:</dt>
	                <dd><input type="text" name="orderCode" class="required" value="test"/></dd>
	            </dl>
	            <dl>
	                <dt>签名:</dt>
