<div class="page" layouth="0">
    <div class="pageFormContent">
        <form class="pageForm required-validate" action="${ctx}/api/ticket/v1/queryFilm">
            <fieldset>
                <legend>查询单个影片信息接口</legend>
                <dl>
                    <dt>渠道编号:</dt>
                ...
                <dl>
                    <dt>影片编码:</dt>
                    <dd><input type="text" name="filmCode" value="100381" class="required"/></dd>
                </dl>
                <dl>
                    <dt>签名:</dt>
