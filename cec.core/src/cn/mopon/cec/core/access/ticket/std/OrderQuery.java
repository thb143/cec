...
public class OrderQuery extends StdQuery {
	@XStreamOmitField
	...
	static {
		...
		xstream.alias("QueryOrder", StdQuery.class, OrderQuery.class);
		xstream.aliasField("QueryOrder", StdServiceQuery.class, "query");
	}
