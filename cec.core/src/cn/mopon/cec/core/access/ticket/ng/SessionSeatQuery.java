...
public class SessionSeatQuery extends NgQuery {
	@XStreamOmitField
	...
	static {
		...
		xstream.alias("QuerySessionSeat", NgQuery.class, SessionSeatQuery.class);
		xstream.aliasField("QuerySessionSeat", NgServiceQuery.class, "query");
	}
