...
public class SeatReply extends NgReply {
	...
	static {
		...
		xstream.alias("QuerySeatReply", NgReply.class, SeatReply.class);
		xstream.aliasField("QuerySeatReply", NgServiceReply.class, "reply");
