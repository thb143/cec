...
public class CinemaReply extends StdReply {
	...
	static {
		...
		xstream.alias("QueryCinemaReply", StdReply.class, CinemaReply.class);
		xstream.aliasField("QueryCinemaReply", StdServiceReply.class, "reply");
