...
public class StdServiceQuery<T extends StdQuery> {
	@XStreamAsAttribute
	 ...
	 *            密码
	 */
	public StdServiceQuery(T query, String username, String password) {
		this.query = query;
	...
	private Document genDocument() throws Exception {
		...
		return sigQueryDocument(document);
	}
	 ...
	 *             抛出异常。
	 */
	private Document sigQueryDocument(Document document) throws Exception {
