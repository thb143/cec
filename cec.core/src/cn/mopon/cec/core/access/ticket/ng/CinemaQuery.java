...
public class CinemaQuery extends NgQuery {
	@XStreamOmitField
	...
	static {
		...
		xstream.alias("QueryCinema", NgQuery.class, CinemaQuery.class);
		xstream.aliasField("QueryCinema", NgServiceQuery.class, "query");
	}
