...
public class OrderReply extends StdReply {
	...
	static {
		...
		xstream.alias("QueryOrderReply", StdReply.class, OrderReply.class);
		xstream.aliasField("QueryOrderReply", StdServiceReply.class, "reply");
