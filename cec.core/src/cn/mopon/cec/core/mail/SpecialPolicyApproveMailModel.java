 ...
 * 待审批特殊定价策略通知。
 */
public class SpecialPolicyApproveMailModel extends MailModel {
	 ...
	 *            邮件接收用户
	 */
	public SpecialPolicyApproveMailModel(SpecialPolicyLog log, List<User> users) {
		super(users);
		templateName = "specialPolicy-approve-mail.ftl";
		subject = "待审批特殊定价策略通知";
