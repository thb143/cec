 ...
 * 审批影院结算策略通过通知。
 */
public class CinemaPolicyApprovePassMailModel extends MailModel {
	 ...
	 *            邮件接收用户
	 */
	public CinemaPolicyApprovePassMailModel(CinemaPolicyLog policyLog,
			List<User> users) {
		super(users);
		templateName = "cinemaPolicy-approve-pass-mail.ftl";
		subject = "审批影院结算策略通过通知";
