 ...
 * 渠道排期补贴预警通知。
 */
public class ChannelShowSubsidyMailModel extends MailModel {
	/** 渠道名称 */
	 ...
	 *            邮件接收用户
	 */
	public ChannelShowSubsidyMailModel(ChannelShow channelShow, List<User> users) {
		super(users);
		templateName = "channelShow-subsidy-mail.ftl";
		subject = "渠道排期补贴预警通知";
